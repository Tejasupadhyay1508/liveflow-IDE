...
const CodeSuggestionCard: React.FC<{
  ...
  return (
    <div className="border border-zinc-700 rounded-lg overflow-hidden bg-zinc-900 my-3 group hover:bg-zinc-950 transition-colors">
  ...
  return (
    <TooltipProvider>
      <>
        ...
        <div
          className={cn(
            "fixed right-0 top-0 bottom-0 h-full z-50 flex flex-col transition-transform duration-300 ease-out shadow-2xl shadow-black/80",
            "bg-black/100 border-l border-zinc-900",
            "w-[45vw] min-w-[280px] sm:w-125 max-w-[500px]",
            "overflow-hidden",
        ...
        >
          ...
          {/* Enhanced Header */}
          <div className="shrink-0 border-b border-zinc-800 bg-black/100">
            <div className="flex flex-col gap-4 px-4 py-5 sm:flex-row sm:items-center sm:justify-between sm:px-6 sm:py-6">
              <div className="flex items-center gap-3">
                <div className="relative w-10 h-10 border border-zinc-800 rounded-xl bg-zinc-900 flex items-center justify-center shadow-inner">
                  <Image
                    src="/logo.svg"
                    alt="Logo"
                    width={24}
                ...
                <div className="flex items-center gap-2">
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-7 h-8 w-40 bg-zinc-800 border-zinc-700"
                    />
                  </div>
          ...
          {/* Messages Container */}
          <div className="flex-1 overflow-y-auto bg-black/100">
            <div className="p-6 space-y-6">
                  ...
                  >
                    ...
                    <div
                      className={cn(
                        ...
                        msg.role === "user"
                          ? "bg-zinc-900 text-white p-4 rounded-br-md"
                          : "bg-zinc-900 text-zinc-100 p-5 rounded-bl-md border border-zinc-800"
                      )}
                    >
                      {msg.role === "assistant" && (
              ...
              {isLoading && (
                <div className="flex items-start gap-4 justify-start">
                  ...
                  <div className="bg-zinc-900 border border-zinc-800 p-5 rounded-xl rounded-bl-md flex items-center gap-3">
          ...
          {attachments.length > 0 && (
            <div className="shrink-0 border-t border-zinc-800 bg-black/100 p-4">
          ...
          <form
            ...
            className="shrink-0 p-4 border-t border-zinc-800 bg-black/100"
          >
            <div className="flex items-end gap-3">
              <div className="flex-1 relative">
                <Textarea
                  ...
                  disabled={isLoading}
                  className="min-h-11 max-h-32 bg-black/100 border-zinc-700 text-zinc-100 placeholder-zinc-500 focus:border-blue-500 focus:ring-blue-500/20 resize-none pr-20"
                  rows={1}
                />
